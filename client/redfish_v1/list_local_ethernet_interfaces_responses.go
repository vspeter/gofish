...
func (o *ListLocalEthernetInterfacesOK) Error() string {
	return fmt.Sprintf("[GET /Managers/CIMC/EthernetInterfaces][%d] listLocalEthernetInterfacesOK  %+v", 200, o.Payload)
}

func (o *ListLocalEthernetInterfacesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListLocalEthernetInterfacesBadRequest) Error() string {
	return fmt.Sprintf("[GET /Managers/CIMC/EthernetInterfaces][%d] listLocalEthernetInterfacesBadRequest ", 400)
}

func (o *ListLocalEthernetInterfacesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListLocalEthernetInterfacesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /Managers/CIMC/EthernetInterfaces][%d] listLocalEthernetInterfacesUnauthorized ", 401)
}

func (o *ListLocalEthernetInterfacesUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListLocalEthernetInterfacesForbidden) Error() string {
	return fmt.Sprintf("[GET /Managers/CIMC/EthernetInterfaces][%d] listLocalEthernetInterfacesForbidden ", 403)
}

func (o *ListLocalEthernetInterfacesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListLocalEthernetInterfacesNotFound) Error() string {
	return fmt.Sprintf("[GET /Managers/CIMC/EthernetInterfaces][%d] listLocalEthernetInterfacesNotFound ", 404)
}

func (o *ListLocalEthernetInterfacesNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListLocalEthernetInterfacesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /Managers/CIMC/EthernetInterfaces][%d] listLocalEthernetInterfacesInternalServerError  %+v", 500, o.Payload)
}

func (o *ListLocalEthernetInterfacesInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
